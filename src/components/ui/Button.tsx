...
export default function Button({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`relative overflow-hidden inline-flex items-center justify-center px-8 py-3 font-semibold bg-transparent transition-all duration-300 select-none rounded-tr-full border border-neutral-400 ${className}`}
    >
