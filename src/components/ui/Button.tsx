...
export default function Button({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`relative overflow-hidden inline-flex items-center  hover:text-white justify-center px-8 py-3 font-semibold bg-transparent transition-all duration-300 select-none rounded-tr-full ease-in-out  rounded-bl-full border border-neutral-400 ${className}`}
    >
